...
DEPLOYMENT_CAPABILITY_PROFILES: Mapping[str, DeploymentCapabilityProfile] = MappingProxyType(
    {
        ...
        for profile in (
            DeploymentCapabilityProfile(
                ...
                calibration_profile_id="hash-local-whole-chunk@v1",
                default_rag_profile_id=None,
                default_index_profile_id="development-hash@v1",
                feature_flags=("test_lab", "ephemeral_tuning"),
            ),
            DeploymentCapabilityProfile(
                id="hosted-managed@v1",
                ...
                calibration_profile_id="cohere-v4-managed-whole-chunk@v1",
                default_rag_profile_id=None,
                default_index_profile_id="hosted-cohere-v4@v1",
            ...
            DeploymentCapabilityProfile(
                ...
                default_generation_model_id="deployment-default",
                calibration_profile_id="openai-large-cohere-whole-chunk@v1",
                default_rag_profile_id=None,
                default_index_profile_id="hosted-openai-large@v1",
                feature_flags=("hosted", "web_search", "query_translation", "rerank_fail_open"),
            ),
            DeploymentCapabilityProfile(
                id="private-ollama@v1",
                ...
                allowed_generation_model_ids=("deployment-default",),
                default_generation_model_id="deployment-default",
                calibration_profile_id="ollama-1024-local-whole-chunk@v1",
                default_rag_profile_id=None,
                default_index_profile_id="private-ollama-1024@v1",
