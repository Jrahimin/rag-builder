"""Health and readiness orchestration.

Liveness answers "is the process up?" (cheap, always succeeds while the app
runs). Readiness answers "can the app serve traffic?" by probing every
critical downstream dependency in parallel and aggregating the result.
"""
