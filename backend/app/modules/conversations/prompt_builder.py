        ...
        *,
        ...
        if partial_answer:
            system_content += (
                ...
                "Lead with independently supported findings from the reviewed scope and cited "
                "evidence. Follow with concise unresolved facets in one short closing paragraph. "
                "Preserve applicability conditions and uncertainty. "
                "Coverage limitations describe only the selected evidence actually reviewed, "
                "not corpus-wide absence. "
