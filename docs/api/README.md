...
| Admin users | [admin_users_api.md](admin_users_api.md) | `/api/v1/admin-users` |
...
| Contextual generation | [generation_api.md](generation_api.md) | `/api/v1/projects/{project_id}/generations` |
